...
class Drug(models.Model):
    ...
    date = models.DateField(help_text="Please display in the form hh:mm:ss!")
    shift_hours = models.DurationField(verbose_name="Shift Hours", help_text="Please display in the form yyyy-mm-dd!")
